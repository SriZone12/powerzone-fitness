...
export default function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    const insertData = {
      ...
      is_new_member: !existingMemberClaim,
      admission_fee_paid: false,
      existing_member_claim: existingMemberClaim,
      claim_status: existingMemberClaim ? 'pending' : 'none',
      ...
      fitness_goals: form.fitnessGoals || null
    }
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="bg-gray-900 p-6 sm:p-8 rounded-lg w-full max-w-lg">
        ...
        <h2 className="text-lg text-gray-400 text-center mb-6">Member Registration</h2>
